...
import { Clock, Heart, Wind, Activity, Flame, Zap, User, Trophy } from 'lucide-react';
...
export function hasActiveFilters(filters: CategoryFilters): boolean {
  return filters.duration !== null || filters.zones.length > 0 || filters.collection !== null || filters.mine;
}
...
type CategoryType = 'duration' | 'zone' | 'collection' | 'special';
