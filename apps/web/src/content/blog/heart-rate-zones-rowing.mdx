...
1. **[Test your FTP.](/blog/rowing-ftp-test)** Without it, zone targets are guesses.
...
A [structured training plan](/plans) enforces the 80/20 split automatically — it removes the decision so you don't drift to Zone 3 purgatory every session.
