...
RowCraft includes [structured plans](/plans) for different experience levels:

- **[Pete Plan](/plans/pete-plan)** (Beginner, 6 weeks) — 3 sessions per week. The best starting point for most rowers.
- **[Return to Rowing](/plans/return-to-rowing)** (Beginner, 4 weeks) — A comeback program for rowers who've been away from the erg.
- **[FTP Builder](/plans/ftp-builder)** (Intermediate, 6 weeks) — Focused on raising your threshold power through targeted Zone 3–4 work.
- **[2K Race Prep](/plans/2k-race-prep)** (Advanced, 4 weeks) — Race-specific preparation with sharpening intervals and a final 2K test.

Each plan session loads directly to your PM5. Pace targets, stroke rate targets, and rest periods are all pre-configured based on your [FTP](/blog/rowing-ftp-test).
