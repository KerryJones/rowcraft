...
The [Pete Plan](/plans/pete-plan) is a built-in 6-week training plan. Every session is pre-programmed:

- Open the [Plans section](/plans) and select Pete Plan
- Each week shows three sessions with the workout already linked
- Tap a session, connect to your PM5, and start rowing
- Pace targets are calculated from your [FTP](/blog/rowing-ftp-test) — no manual setup
...
- **[Move to FTP Builder.](/plans/ftp-builder)** A 6-week intermediate plan focused on raising your threshold power.
- **[Try 2K Race Prep.](/plans/2k-race-prep)** A 4-week advanced plan if you're training for a specific time trial or competition.
